      ...
      <div className="flex justify-center mb-4">
        <div className="flex items-center space-x-10">
          <div className="flex flex-col items-center space-y-1">
            ...
            <span className="text-sm text-gray-700 font-semibold">Reserved</span>
          </div>
          <div className="flex flex-col items-center space-y-1">
            <div className="w-10 h-10 bg-green-300 border border-gray-400 rounded-sm"></div>
            <span className="text-sm text-gray-700 font-semibold">Selected</span>
          </div>
          <div className="flex flex-col items-center space-y-1">
    ...
    <tbody>
      ...
      <div className="text-center mt-4">
        <button
          ...
          onClick={() => (window.location.href = "labtech-reservation.html")}
        >
          Reserve Slot
        </button>
      </div>
